...
M.setup = function()
  ...
  local groups = {
    ...
    CursorNormal = { bg = colors.fg1, fg = colors.fg1 },
    CursorVisual = { bg = colors.purple, fg = colors.purple },
    CursorCommand = { bg = colors.orange, fg = colors.orange },
    CursorInsert = { bg = colors.aqua, fg = colors.aqua },
    ...
    WarningMsg = { link = "GruvboxYellowBold" },
